...
# Color palette - soft, professional colors (original)
colors = {
...
ax.text(1.3, 7.5, 'DATA SOURCES', ha='center', va='center', fontsize=14,
        fontweight='bold', color='#444444')
ax.text(5.0, 7.5, 'PROCESSING', ha='center', va='center', fontsize=14,
        fontweight='bold', color='#444444')
ax.text(8.5, 7.5, 'MODELING', ha='center', va='center', fontsize=14,
        fontweight='bold', color='#444444')
ax.text(12.0, 7.5, 'RESULTS', ha='center', va='center', fontsize=14,
        fontweight='bold', color='#444444')
...
ax.text(5.0, 5.2, 'Feature', ha='center', va='center', fontsize=14,
        fontweight='bold', color=colors['text'])
ax.text(5.0, 4.8, 'Engineering', ha='center', va='center', fontsize=14,
        fontweight='bold', color=colors['text'])
...
ax.text(8.5, 5.2, 'XGBoost', ha='center', va='center', fontsize=14,
        fontweight='bold', color=colors['text'])
ax.text(8.5, 4.8, 'Regression', ha='center', va='center', fontsize=14,
        fontweight='bold', color=colors['text'])
...
ax.text(12.0, 5.2, 'Key Findings', ha='center', va='center', fontsize=14,
        fontweight='bold', color=colors['text'])
...
ax.text(12.0, 4.0, '#2 Formaldehyde', ha='center', va='center',
        fontsize=13, fontweight='bold', color='#c41e3a')  # Highlighted
...
# Add sample info at bottom - LARGER
